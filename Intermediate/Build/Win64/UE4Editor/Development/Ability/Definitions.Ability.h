...
#define UE_PROJECT_NAME AttributeSystem
#define UE_TARGET_NAME AttributeSystemEditor
#define UE_MODULE_NAME "Ability"
#define UE_PLUGIN_NAME "Ability"
